    ...
    internal class DistanceToTarget : AbstractCondition
    {
        ...
        private void CreateText(List<Node> re)
        {
            ...
            LabelX control = new LabelX {
                ...
                Text = "This condition will give you the distance to your target (yards).",
                Visible = true,
        ...
        public override bool IsOk =>
            (!this.Condition.Equals(ConditionEnum.EqualTo) || !LazyLib.Wow.ObjectManager.MyPlayer.IsValid) ? ((!this.Condition.Equals(ConditionEnum.LessThan) || !LazyLib.Wow.ObjectManager.MyPlayer.IsValid) ? (this.Condition.Equals(ConditionEnum.MoreThan) && (LazyLib.Wow.ObjectManager.MyPlayer.IsValid && (LazyLib.Wow.ObjectManager.MyPlayer.Target.DistanceToSelf > this.Value))) : (LazyLib.Wow.ObjectManager.MyPlayer.Target.DistanceToSelf < this.Value)) : (LazyLib.Wow.ObjectManager.MyPlayer.Target.DistanceToSelf == this.Value);
    }
}
