namespace LazyEvo.PVEBehavior.Behavior.Conditions
{
    ...
    internal class HealthStoneCount : AbstractCondition
    {
        ...
        public override bool IsOk =>
            !this.Condition.Equals(ConditionEnum.EqualTo) ? (!this.Condition.Equals(ConditionEnum.LessThan) ? (this.Condition.Equals(ConditionEnum.MoreThan) && (LazyLib.Wow.ObjectManager.MyPlayer.HealthStoneCount > this.Value)) : (LazyLib.Wow.ObjectManager.MyPlayer.HealthStoneCount < this.Value)) : (LazyLib.Wow.ObjectManager.MyPlayer.HealthStoneCount == this.Value);
    }
}
