namespace LazyEvo.PVEBehavior.Behavior.Conditions
{
    ...
    internal class SoulShardCountCondition : AbstractCondition
    {
        ...
        public override bool IsOk =>
            !this.Condition.Equals(ConditionEnum.EqualTo) ? (!this.Condition.Equals(ConditionEnum.LessThan) ? (this.Condition.Equals(ConditionEnum.MoreThan) && (LazyLib.Wow.ObjectManager.MyPlayer.SoulShard > this.Value)) : (LazyLib.Wow.ObjectManager.MyPlayer.SoulShard < this.Value)) : (LazyLib.Wow.ObjectManager.MyPlayer.SoulShard == this.Value);
    }
}
